...
class ChatChannel(Channel):
    ...
    def _resolve_agent_id(self, context: Context) -> str:
        ...
        # Session keys generated by the web UI are prefixed as agent_id:session_id.
        raw_session_id = str(context.get("session_id", "") or "").strip()
        ...
        if isinstance(bindings, dict):
            bound_agent = str(bindings.get(channel_type, "") or "").strip()
            if bound_agent:
                return bound_agent
